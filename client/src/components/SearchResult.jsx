...
class SearchResult extends Component {
	...
	setEffectsState() {
		...
		let url = `https://strainapi.evanbusse.com/${process.env.API_KEY}/strains/data/effects/${clickedID}`;
		let flavorURL = `https://strainapi.evanbusse.com/${process.env.API_KEY}/strains/data/flavors/${clickedID}`;
